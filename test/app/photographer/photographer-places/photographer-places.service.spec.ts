...
describe('PhotographerPlacesService', () => {
  ...
  it('test getPhotographers()', inject([PhotographerPlacesService, MockBackend], fakeAsync((photographerPlacesService,
                                                                                       mockBackend) => {
    var res;
    ...
    photographerPlacesService.getPhotographerPlaces('id=56ec091caf72e9437cbccfab').subscribe((_res) => {
      res = _res;
    });
    tick();
