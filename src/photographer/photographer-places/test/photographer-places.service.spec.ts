...
describe('PhotographerPlacesService', () => {
    ...
    let photographerPlacesService: PhotographerPlacesService;
    ...
    beforeEach(async() => {
        ...
        photographerPlacesService = testBed.get(PhotographerPlacesService);
    });

    it('getPhotographerPlaces()', fakeAsync(() => {
