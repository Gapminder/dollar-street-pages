...
export class DonateComponent implements OnInit, OnDestroy, AfterViewChecked {
    ...
    public constructor(loaderService: LoaderService,
        ...
        this.accordionData = [
            {sectionName: 'What if we are gonna add our home?',sectionContent: 'Sed non justo eget lacus pretium aliquam sit amet nec enim. Etiam vulputate nec est vitae pulvinar. Aliquam consequat vitae magna id semper. Nulla congue sapien quis sapien posuere suscipit. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Sed sit amet diam sit amet justo pharetra malesuada ac id lorem.'},
            {sectionName: 'What if we are gonna add our home?',sectionContent: 'Sed non justo eget lacus pretium aliquam sit amet nec enim. Etiam vulputate nec est vitae pulvinar. Aliquam consequat vitae magna id semper. Nulla congue sapien quis sapien posuere suscipit. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Sed sit amet diam sit amet justo pharetra malesuada ac id lorem.'},
            {sectionName: 'What if we are gonna add our home?',sectionContent: 'Sed non justo eget lacus pretium aliquam sit amet nec enim. Etiam vulputate nec est vitae pulvinar. Aliquam consequat vitae magna id semper. Nulla congue sapien quis sapien posuere suscipit. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Sed sit amet diam sit amet justo pharetra malesuada ac id lorem.'}
        ];
    }
    ...
    public purchaseClicked(value: number): void {
        this.makeDonate(value);
    }

    private makeDonate(value: number): void {
        if(!value) {
