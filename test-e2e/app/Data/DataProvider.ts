...
module.exports = {
  ...
  matrixPageText:{
    'H2 -by income- in header': {element: function () {return $('span[class="income-sorted"]'); }, actualResult: ' by income'},
    'Poorest header on Street Widget': {element: function () {return $('text[class="poorest"]'); }, actualResult: 'Poorest 3$'},
    'Richest header on Street Widget': {element: function () {return $('text[class="richest"]'); }, actualResult: 'Richest'},
  ...
  matrixPageBoolean:{
    ...
    'Glass icon in header': {element: function () {return $('.matrix-search-button>img'); }},
  ...
  matrixPageSearchText:{
    ...
    'Places header in Search': {element: function () {return element.all(by.css('.search-list-header>h3')).last(); }, actualResult: 'PLACES'},
    'Things category -Home- in Search': {element: function (){return element.all(by.css('.category-name>span')).first(); }, actualResult: 'Home from outside'},
    'Things category -Agriculture- in Search': {element: function (){return element.all(by.css('.category-name>span')).get(1); }, actualResult: 'Agriculture'},
    'Things category -Countries- in Search': {element: function (){return element.all(by.css('.category-name>span')).last(); }, actualResult: 'Countries'},
